...
use CollegeFootball\AppBundle\Entity\News;
use CollegeFootball\AppBundle\Entity\NewsUpdate;
...
class NewsService
{
    ...
    {
        $repository       = $this->em->getRepository('CollegeFootballAppBundle:NewsUpdate');
